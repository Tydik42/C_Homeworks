...

{
    ...
    UnityAssertEqualNumber((UNITY_INT)((1)), (UNITY_INT)((mostFrequentElement(array, arrayLength))), (
...

{
    ...
    UnityAssertEqualNumber((UNITY_INT)((34)), (UNITY_INT)((mostFrequentElement(array, arrayLength))), (
...

{
    ...
    UnityAssertEqualNumber((UNITY_INT)((0)), (UNITY_INT)((mostFrequentElement(array, arrayLength))), (
...

{
    ...
    UnityAssertEqualNumber((UNITY_INT)((42)), (UNITY_INT)((mostFrequentElement(array, arrayLength))), (
