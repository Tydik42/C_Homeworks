...
void test_binary_search(void) {
    ...
    do {if ((binarySearch(array1, 3, 5) == 1)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(204)));}} while(0);

    do {if ((binarySearch(array1, 6, 5) == 0)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(205)));}} while(0);



    int array2[] = {-10, -5, 0, 5, 10};

    do {if ((binarySearch(array2, -5, 5) == 1)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(208)));}} while(0);

    do {if ((binarySearch(array2, 15, 5) == 0)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(209)));}} while(0);



    int array3[] = {100, 200, 300, 400, 500};

    do {if ((binarySearch(array3, 300, 5) == 1)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(212)));}} while(0);

    do {if ((binarySearch(array3, 600, 5) == 0)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(213)));}} while(0);
...
void test_binary_search_with_empty_array(void) {
    ...
    do {if ((binarySearch(array, 1, 0) == 0)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(218)));}} while(0);
...
void test_binary_search_with_single_element(void) {
    ...
    do {if ((binarySearch(array, 42, 1) == 1)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(223)));}} while(0);

    do {if ((binarySearch(array, 1, 1) == 0)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(224)));}} while(0);
...
void test_binary_search_with_duplicates(void) {
    ...
    do {if ((binarySearch(array, 2, 6) == 1)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(229)));}} while(0);

    do {if ((binarySearch(array, 6, 6) == 0)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(230)));}} while(0);
...
void test_binary_search_with_negative_numbers(void) {
    ...
    do {if ((binarySearch(array, -3, 5) == 1)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(235)));}} while(0);

    do {if ((binarySearch(array, 0, 5) == 0)) {} else {UnityFail( ((" Expression Evaluated To FALSE")), (UNITY_UINT)((UNITY_UINT)(236)));}} while(0);
